...
export const ModalMemorandoOficioComunicacionQuejosoInhibitorio = ({
  modalMemorandoOficio,
  setModalMemorandoOficio,
  dataInhibitorio,
}: any) => {
  const handleClose = () => setModalMemorandoOficio(false);
  return (
    <div>
      <Modal
        open={modalMemorandoOficio}
        onClose={handleClose}
