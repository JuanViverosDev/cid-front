...
export const SiConfesar = ({ roles, currentUser, setDocumentAproved, documentAproved }: any) => {
    ...
    <>
      <div className="space-y-6 sm:space-y-5 flex items-end col-span-6">
        <div className="w-full ml-4">
          <h4 className="text-sm leading-6 font-medium text-sidebarSubtitle pb-0">Documentos de confesión</h4>
          ...
          <table className="w-1/2">
            ...
            <tr>
              <td className="py-2 px-2">
                <p className="text-sm underline">Constancia de manifestación de deseo de confesión</p>
              </td>
              <td>
                  ...
                  <>
                    <button
                      ...
                      onClick={() => {
                        ...
                        setTypeOfDocumentToEdit('Constancia de manifestación de deseo de confesión');
                      }}
                    ...
                    {openModalDocsViewer &&
                      typeOfDocumentToEdit === 'Constancia de manifestación de deseo de confesión' && (
                        <DocumentToEdit
                          userLogged={currentUser}
                          openModalDocsViewer={openModalDocsViewer}
                          setOpenModalDocsViewer={setOpenModalDocsViewer}
                          documentName={'Constancia de manifestación de deseo de confesión'}
                        />
                      )}
                  </>
                )}
          ...
          <div style={{ background: '#e8f5e9' }} className=" p-4 w-1/2">
            <Switch
              onChange={(e: any) => {
                setDocumentAproved({
                  ...documentAproved,
                  isAllDocumentsConfesarSiApproved: e.target.checked,
                });
              }}
              color="success"
            />
            ¿Todos los documentos fueron aprobados?
            {documentAproved.isAllDocumentsConfesarSiApproved}
          </div>
        </div>
      </div>
    </>
